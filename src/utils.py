# -*- coding: utf-8 -*-
"""
Created on Tue Apr  8 14:30:32 2025
...
def draw_ellipse(img, center, axes, angle,
    ...
    #uses the shift to accurately get subpixel resolution for arc
    ...
    return cv2.ellipse(img,center,axes,angle,startAngle,
...
def convert_arc(pt1,pt2,sagitta):
    ...
    if np.isclose(M11,0):
        #Error: The points are collinear (sagitta ~ 0)
