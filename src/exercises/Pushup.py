# -*- coding: utf-8 -*-
"""
Created on Tue Apr  8 15:55:32 2025
    ...
    def exercise(self, source):
        ...
        while True:
            ...
            try:
                ...
                if 12 in idx_to_coordinates and 28 in idx_to_coordinates and 16 in idx_to_coordinates: #corresponds to left side of body
            ...
            try:
                ...
                print(abs(shoulder_coord[1] - ankle_coord[1]))
                if abs(shoulder_coord[1] - ankle_coord[1]) < 300:
                    self.performedPushUp = True
                if abs(shoulder_coord[1] - ankle_coord[1]) > 300 and self.performedPushUp:
                    scount += 1
                    self.performedPushUp = False
            ...
            #out = cv2.VideoWriter("pushup_test_output.avi")
